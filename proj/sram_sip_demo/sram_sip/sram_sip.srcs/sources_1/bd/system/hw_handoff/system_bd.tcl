...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI] [get_bd_intf_pins sram_ctrl_0/S00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins sram_ctrl_0/s00_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins sram_ctrl_0/s00_axi_aresetn]
  connect_bd_net -net sram_ctrl_0_clk_out [get_bd_ports clk_out] [get_bd_pins sram_ctrl_0/clk_out]
  connect_bd_net -net sram_ctrl_0_led_0 [get_bd_ports led_0] [get_bd_pins sram_ctrl_0/led_0]
  connect_bd_net -net sram_ctrl_0_led_1 [get_bd_ports led_1] [get_bd_pins sram_ctrl_0/led_1]
  connect_bd_net -net sram_ctrl_0_led_2 [get_bd_ports led_2] [get_bd_pins sram_ctrl_0/led_2]
  connect_bd_net -net sram_ctrl_0_led_3 [get_bd_ports led_3] [get_bd_pins sram_ctrl_0/led_3]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs sram_ctrl_0/S00_AXI/S00_AXI_reg] SEG_sram_ctrl_0_S00_AXI_reg
