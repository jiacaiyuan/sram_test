...
#
# Generated by Vivado on Wed Jan 16 20:03:45 +0800 2019
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    ...
    "$ref_dir/../../../bd/system/ipshared/xilinx.com/sram_ctrl_v1_0/hdl/led.v" \
    "$ref_dir/../../../bd/system/ipshared/xilinx.com/sram_ctrl_v1_0/hdl/sram_ctrl_v1_0_S00_AXI.v" \
    "$ref_dir/../../../bd/system/ipshared/xilinx.com/sram_ctrl_v1_0/hdl/sram_ctrl_v1_0.v" \
    "$ref_dir/../../../bd/system/ip/system_sram_ctrl_0_0/sim/system_sram_ctrl_0_0.v" \
  2>&1 | tee -a vlogan.log
