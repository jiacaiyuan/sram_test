...
#
# Generated by Vivado on Thu Jan 31 11:38:22 +0800 2019
...
vhdlan_opts="-full64"
vcs_elab_opts="-load "E:/vivado/Vivado/2016.1/lib/win64.o/libxil_vcs.dll:xilinx_register_systf" -full64 -debug_pp -t ps -licqueue -l elaborate.log"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    ...
    "$ref_dir/../../../bd/system/ipshared/xilinx.com/sram_control_v1_0/hdl/sram_ctrl.v" \
    "$ref_dir/../../../bd/system/ipshared/xilinx.com/sram_control_v1_0/hdl/sram_control_v1_0_S00_AXI.v" \
    "$ref_dir/../../../bd/system/ipshared/xilinx.com/sram_control_v1_0/hdl/sram_control_v1_0.v" \
...
create_lib_mappings()
{
  libs=(xil_defaultlib xpm processing_system7_bfm_v2_0_5 blk_mem_gen_v8_3_2 lib_cdc_v1_0_2 proc_sys_reset_v5_0_9 generic_baseblocks_v2_1_0 fifo_generator_v13_1_0 axi_data_fifo_v2_1_7 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_8 axi_protocol_converter_v2_1_8)
