...
#/////////////////////	SRAM_CTRL	/////////////////////////
	set_location_assignment		PIN_N20 -to		    s_addr[8]
	set_location_assignment		PIN_M21 -to		    s_addr[9]
	set_location_assignment		PIN_M24 -to		    s_addr[6]
	set_location_assignment		PIN_M25 -to		    s_addr[7]
	set_location_assignment		PIN_N24 -to		    s_addr[4]
	set_location_assignment		PIN_P24 -to		    s_addr[5]
	set_location_assignment		PIN_R25 -to		    s_addr[2]
	set_location_assignment		PIN_R24 -to		    s_addr[3]
	set_location_assignment		PIN_R20 -to		    s_addr[0]
	set_location_assignment		PIN_T22 -to		    s_addr[1]
	set_location_assignment		PIN_T23 -to		    s_cen
	set_location_assignment		PIN_T24 -to		    s_wen
	set_location_assignment		PIN_T25 -to		    s_oen
	set_location_assignment		PIN_T18 -to		    s_clk
	set_location_assignment		PIN_T21 -to		    s_ddata[4]
	set_location_assignment		PIN_T20 -to		    s_qdata[4]
	set_location_assignment		PIN_U26 -to		    s_ddata[5]
	set_location_assignment		PIN_U25 -to		    s_qdata[5]
	set_location_assignment		PIN_U23 -to		    s_ddata[6]
	set_location_assignment		PIN_U24 -to		    s_qdata[6]
	set_location_assignment		PIN_R19 -to		    s_ddata[7]
	set_location_assignment		PIN_T19 -to		    s_qdata[7]
	set_location_assignment		PIN_U20 -to		    s_ddata[0]
	set_location_assignment		PIN_U21 -to		    s_qdata[0]
	set_location_assignment		PIN_V26 -to		    s_ddata[1]
	set_location_assignment		PIN_V25 -to		    s_qdata[1]
	set_location_assignment		PIN_V24 -to		    s_ddata[2]
	set_location_assignment		PIN_V23 -to		    s_qdata[2]
	set_location_assignment		PIN_W25 -to		    s_ddata[3]
	set_location_assignment		PIN_W23 -to		    s_qdata[3]
