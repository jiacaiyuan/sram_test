...
#
# Generated: 2019-04-10 20:10:13.432
...
ptf=D:\sram_test\sram_sip_15\sram_sip_quartus\system0.ptf
...
sidp=0x00801040
id=611894095u
timestamp=1554360052u

# Include operating system specific parameters, if they are supplied.

if test -f /cygdrive/f/quartus/nios2eds/components/micrium_uc_osii/build/os.sh ; then
   . /cygdrive/f/quartus/nios2eds/components/micrium_uc_osii/build/os.sh
fi
