...
int main()
{
    ...
    while(1)
    {
         ...
         *  and you need to ignore it,the other types also trigger the interrupt,and it's so frequency that maybe
         *  it can't receive the recall info from PC and it's useless,so the ARM may don't receive
