//
//      CONFIDENTIAL AND PROPRIETARY SOFTWARE/DATA OF CTian COMPONENTS, INC.
//      
//      Copyright (c) 2018 CTian Components, Inc.  All Rights Reserved.
//      
//      Use of this Software/Data is subject to the terms and conditions of
//      the applicable license agreement between CTian Components, Inc. and
//      SMIC.  In addition, this Software/Data
//      is protected by copyright law and international treaties.
//      
//      The copyright notice(s) in this Software/Data does not indicate actual
//      or intended publication of this Software/Data.
//      name:			DICE-SRAM-SP-HS SRAM Generator
//           			SMIC 0.18um Logic018 Process
//      version:		2018.1.0
//      comment:		
//      configuration:	 -instname "sram_zhouyi" -frequency 1 -ring_width 2 -drive 12 -write_mask off -wp_size 8 -top_layer met6 -power_type rings -horiz met3 -vert met4 -cust_comment "" -left_bus_delim "[" -right_bus_delim "]" -pwr_gnd_rename "VDD:VDD,GND:VSS" -prefix "" -pin_space 0.0 -name_case upper -check_instname on -diodes on -inside_ring_type GND
//
//      Verilog model for Synchronous Single-Port Ram
//
//      Instance Name:  W1024B8M16
//      Words:          1024
//      Word Width:     8
//      Pipeline:       No
//
...
//          to run static path timing tools using CTian supplied
