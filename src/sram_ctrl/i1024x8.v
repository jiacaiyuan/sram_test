...
//      version:		2003Q2V2
//      comment:		
//      configuration:	 -instname i1024x8 -words 1024 -bits 8 -frequency 1 -ring_width 2 -mux 16 -drive 12 -write_mask off -wp_size 8 -top_layer met6 -power_type rings -horiz met3 -vert met4 -cust_comment "" -left_bus_delim "[" -right_bus_delim "]" -pwr_gnd_rename "VDD:VDD,GND:VSS" -prefix "" -pin_space 0.0 -name_case upper -check_instname on -diodes on -inside_ring_type GND
//
//      Verilog model for Synchronous Single-Port Ram
//
//      Instance Name:  i1024x8
//      Words:          1024
//      Word Width:     8
//      Pipeline:       No
//
//      Creation Date:  2019-01-09 01:55:59Z
//      Version: 	2003Q2V2
//
